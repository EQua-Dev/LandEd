...
class Farming : Fragment() {
    ...
    var farmingLandAdapter: FirestoreRecyclerAdapter<LandDetail, LandAvailableAdapter>? = null
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        getRealTimeFarmingLands()


        val layoutManager = LinearLayoutManager(requireContext())
        rv_farming_land.layoutManager = layoutManager
        rv_farming_land.addItemDecoration(
    ...
    private fun getRealTimeFarmingLands() {

        val fireStore = FirebaseFirestore.getInstance()
        val availableLands = fireStore.collection("Land")
        val query = availableLands.whereEqualTo("status", "available").whereEqualTo("urp","farming")
        ...
        rv_home_available.adapter = farmingLandAdapter
...
//        title.text = title
    ...
    override fun onStart() {
        ...
        farmingLandAdapter!!.startListening()
    }
    ...
    override fun onStop() {
        ...
        if (farmingLandAdapter != null)
            farmingLandAdapter!!.stopListening()
    }
