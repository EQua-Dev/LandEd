...
class Residential : Fragment() {
    ...
    var residentialLandAdapter: FirestoreRecyclerAdapter<LandDetail, LandAvailableAdapter>? = null
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        getRealTimeResidentialLands()


        val layoutManager = LinearLayoutManager(requireContext())
        rv_residential_land.layoutManager = layoutManager
        rv_residential_land.addItemDecoration(
    ...
    private fun getRealTimeResidentialLands() {

        val fireStore = FirebaseFirestore.getInstance()
        val availableLands = fireStore.collection("Land")
        val query = availableLands.whereEqualTo("status", "available").whereEqualTo("urp","residential")
...
//        title.text = title
    ...
    override fun onStart() {
        ...
        residentialLandAdapter!!.startListening()
    }
    ...
    override fun onStop() {
        ...
        if (residentialLandAdapter != null)
            residentialLandAdapter!!.stopListening()
    }
