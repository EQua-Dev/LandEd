...
class Business : Fragment() {
    ...
    var businessLandAdapter: FirestoreRecyclerAdapter<LandDetail, LandAvailableAdapter>? = null
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        getRealTimeBusinessLands()


        val layoutManager = LinearLayoutManager(requireContext())
        rv_business_land.layoutManager = layoutManager
        rv_business_land.addItemDecoration(
    ...
    private fun getRealTimeBusinessLands() {

        val fireStore = FirebaseFirestore.getInstance()
        val availableLands = fireStore.collection("Land")
        val query = availableLands.whereEqualTo("status", "available").whereEqualTo("urp","business")
        ...
        rv_home_available.adapter = businessLandAdapter
...
//        title.text = title
    ...
    override fun onStart() {
        ...
        businessLandAdapter!!.startListening()
    }
    ...
    override fun onStop() {
        ...
        if (businessLandAdapter != null)
            businessLandAdapter!!.stopListening()
    }
