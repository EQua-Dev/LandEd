...
class Recreational : Fragment() {

    var recreationalLandAdapter: FirestoreRecyclerAdapter<LandDetail, LandAvailableAdapter>? = null
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        getRealTimeRecreationalLands()


        val layoutManager = LinearLayoutManager(requireContext())
        rv_recreational_land.layoutManager = layoutManager
        rv_recreational_land.addItemDecoration(
    ...
    private fun getRealTimeRecreationalLands() {

        val fireStore = FirebaseFirestore.getInstance()
        val availableLands = fireStore.collection("Land")
        val query = availableLands.whereEqualTo("status", "available").whereEqualTo("urp","recreational")
...
//        title.text = title
    ...
    override fun onStart() {
        ...
        recreationalLandAdapter!!.startListening()
    }
    ...
    override fun onStop() {
        ...
        if (recreationalLandAdapter != null)
            recreationalLandAdapter!!.stopListening()
    }
